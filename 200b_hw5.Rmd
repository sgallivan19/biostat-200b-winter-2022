...
* $\hat\beta_{0}$ = 2.98003. Intercept of the line. The expected value of log transformed doctors per 1000 population when all independent variables in the model are equal to zero. 
* $\hat\beta_{1}$ = 0.04832. The percent increase of doctors per 1000 population for a one percent increase in population density, controlling for the other variables in the model. 
* $\hat\beta_{2}$ = 0.15378. An $e^.15378$ multiplicative increase of doctors per 1000 population for a one-unit increase in hospital beds per 1000 population, controlling for the other variables in the model.
* $\hat\beta_{3}$ = 0.01711. An $e^.01711$ multiplicative increase of doctors per 1000 population for a one-unit increase in percent of adults who graduated high school, controlling for the other variables in the model.
* $\hat\beta_{4}$ = 0.04025. An $e^.04025$ multiplicative increase of doctors per 1000 population for a one-unit increase in percent of adults with income below the poverty line, controlling for the other variables in the model.
* $\hat\beta_{5}$ = -0.02622. An $e^{-.02622}$ multiplicative decrease of doctors per 1000 population for a one-unit increase in percent of unemployed labor force, controlling for the other variables in the model.
* $\hat\beta_{6}$ = 0.06515. An $e^.06515$ multiplicative increase of doctors per 1000 population for a one-unit increase in per capita income (in thousands), controlling for the other variables in the model.
