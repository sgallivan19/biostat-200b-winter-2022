...
* $\hat\beta_{2}$ = 0.15378. The percent increase of doctors per 1000 population for a one-unit increase in hospital beds per 1000 population, controlling for the other variables in the model.
* $\hat\beta_{3}$ = 0.01711. The percent increase of doctors per 1000 population for a one-unit increase in percent of adults who graduated high school, controlling for the other variables in the model.
* $\hat\beta_{4}$ = 0.04025. The percent increase of doctors per 1000 population for a one-unit increase in percent of adults with income below the poverty line, controlling for the other variables in the model.
* $\hat\beta_{5}$ = -0.02622. The percent decrease of doctors per 1000 population for a one-unit increase in percent of unemployed labor force, controlling for the other variables in the model.
* $\hat\beta_{6}$ = 0.06515. The percent increase of doctors per 1000 population for a one-unit increase in per capita income (in thousands), controlling for the other variables in the model.
