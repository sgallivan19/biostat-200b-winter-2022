...
create list of variables to loop through for tests (excluding income3 and site)
```{r}
varslist <- c("cesd1", "fsi1", "isi1", "bmi", "ageBaseline", 
              "ageDiagnosis", "yearsSinceDiagnosis", "married")
varslist
```
